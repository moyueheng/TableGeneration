...
def parse_args():
    ...
    parser.add_argument(
        "--num", type=int, default=1, help="the number of generate table"
    )
    # output path
    parser.add_argument(
        "--output", type=str, default="output/simple_table"
    )  # data save path
    # courp path
    ...
    # row and col span
    parser.add_argument(
        "--max_span_row_count", type=int, default=3, help="max span rows"
    )
    parser.add_argument(
        "--max_span_col_count", type=int, default=3, help="max span cols"
    )
    parser.add_argument(
        "--max_span_value",
        type=int,
        default=10,
        help="max value in rowspan and colspan",
    )
    # txts lens
    parser.add_argument(
        "--min_txt_len", type=int, default=2, help="min number of char in cell"
    )
    parser.add_argument(
        "--max_txt_len", type=int, default=10, help="max number of char in cell"
    )
    # color
    parser.add_argument(
        "--color_prob", type=float, default=0, help="the prob of color cell"
    )
    # cell size
    parser.add_argument(
        "--cell_max_width", type=int, default=0, help="max width of cell"
    )
    parser.add_argument(
        "--cell_max_height", type=int, default=0, help="max height of cell"
    )
    # windows size
    parser.add_argument(
    ...
    parser.add_argument(
        "--brower", type=str, default="chrome", help="chrome or firefox"
    )
    # backgroud
    parser.add_argument(
        "--backgroud",
        ...
        help="Create a background with Gaussian noise (to mimic paper)",
    )
